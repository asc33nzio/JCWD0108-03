...
export const ProductsByCategory = () => {
    ...
    const productsByCategory = async (pageNum) => {
        try {
            const response = await Axios.get(`http://localhost:8000/api/products/category/${params.categoryId}?page=${pageNum}`);

...
export const Cart = () => {
    return(
        <Box>
            <Box borderBottomRadius={"0px"} borderTopRadius={"10px"} bgGradient={"linear(yellow.500,#FFC900)"} ml={{base:'10px', sm:'25px', md:'80px'}} w={{base:'155px', sm:'180px', md:'220px', lg:'300px', xl:'500px'}}>
